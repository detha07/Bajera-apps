            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebarLayouts">
                <ul class="nav nav-collapse">
                  <li><a href="{{ url('/rsetor') }}"><span class="sub-item">Riwayat Setor</span></a></li>
                  <li><a href="{{ url('/rtarik') }}"><span class="sub-item">Riwayat Penarikan</span></a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
...
<!-- ...Potongan kode di atas tetap sama -->
